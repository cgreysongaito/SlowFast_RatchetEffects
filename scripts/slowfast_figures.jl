...
let
    ...
    subplot(3,2,1)
    plot(log10.(1 ./ wn_data05_long_RozMac.xrange), wn_data05_long_RozMac.canard, color = "black", linestyle = "dotted", linewidth=2)
    ...
    yticks(fontsize=12)
    subplot(3,2,2)
    plot(log10.(1 ./ wn_data07_long_RozMac.xrange), wn_data07_long_RozMac.canard, color = "black", linestyle = "dotted", linewidth=2)
    ylim(0,1)
    xticks(fontsize=12)
    yticks(fontsize=12)
    xlabel("Log10 of 1/ϵ", fontsize = 15)
