...
let
    ...
    fill_between(rn_data_ep0079eff05.xrange, fill(1.0,10), rn_data_ep0079eff05.canard_plus_axial, color="#FDE725FF")
    ylabel("Proportion")
    ylim(0,1)
    subplot(2,3,2)
    ...
    fill_between(rn_data_ep0079eff06.xrange, fill(1.0,10), rn_data_ep0079eff06.canard_plus_axial, color="#FDE725FF")
    ...
    fill_between(rn_data_ep0079eff07.xrange, fill(1.0,10), rn_data_ep0079eff07.canard_plus_axial, color="#FDE725FF")
    ylim(0,1)
    ...
    fill_between(rn_data_ep0004eff05.xrange, fill(1.0,10), rn_data_ep0004eff05.canard_plus_axial, color="#FDE725FF")
    ylabel("Proportion")
    ylim(0,1)
    subplot(2,3,5)
    ...
    fill_between(rn_data_ep0004eff06.xrange, fill(1.0,10), rn_data_ep0004eff06.canard_plus_axial, color="#FDE725FF")
    xlabel("Noise correlation (t = -1)")
    ylim(0,1)
    subplot(2,3,6)
    ...
    fill_between(rn_data_ep0004eff07.xrange, fill(1.0,10), rn_data_ep0004eff07.canard_plus_axial, color="#FDE725FF")
    ylim(0,1)
    tight_layout()
