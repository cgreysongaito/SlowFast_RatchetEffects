...
let
    ...
    fill_between(collect(0.0:0.1:0.9), axial_rn_dataset[1], color="#440154FF")
    ...
    fill_between(collect(0.0:0.1:0.9), axial_rn_dataset[2], color="#440154FF")
    ...
    fill_between(collect(0.0:0.1:0.9), axial_rn_dataset[3], color="#440154FF")
    ylim(0,1)
    title("e = 0.7, ϵ = 0.079")
    tight_layout()
    return figure3b
